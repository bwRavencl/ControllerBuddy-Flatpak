...
wrapper_utils_sh_path="$(dirname "${BASH_SOURCE[0]}")/wrapper-utils.sh"
readonly wrapper_utils_sh_path
...
if [[ -f "$wrapper_utils_sh_path" ]]
then
    # shellcheck source=./wrapper-utils.sh
    source "$wrapper_utils_sh_path"
else
